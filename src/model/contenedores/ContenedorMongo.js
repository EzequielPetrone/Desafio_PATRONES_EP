const logger = require('../../utils/logger') //Importo logger que configuré

// Importo Singleton para la conexión con Mongo
const SingletonMongo = require('../models/SingletonMongo')
...
class ContenedorMongo {
    ...
    async getAll() { //return Object[] - Devuelve un array con los objetos presentes en el archivo.
        try {
            ...
            logger.error(`Error al querer leer el contenido de la colección ${this.model.modelName}...` + error)
            return null
        }
    }
    ...
    async save(obj) { //return Number - Recibe un objeto, lo guarda en el archivo, devuelve el id asignado.
        try {
            ...
            logger.error(`Pasaron cosas al guardar nuevo objeto en la colección ${this.model.modelName}...` + error)
            return null
        }
    }
    ...
    async getById(id) { //return Object - Recibe un id y devuelve el objeto con ese id, o null si no está.
        try {
            ...
            logger.error(`Error al obtener objeto con id ${id} de la colección ${this.model.modelName}...` + error);
            return null
        }
    }
    ...
    async deleteById(id) { //: void - Elimina del archivo el objeto con el id buscado.
        try {
            ...
            logger.error(`Error al eliminar objeto con id ${id} de la colección ${this.model.modelName}...` + error);
            return null
        }
    }
    ...
    */
    ...
    async editById(id, obj) {
        try {
            ...
            logger.error(`Error al editar objeto con id ${id} de la colección ${this.model.modelName}...` + error);
            return null
        }
    }
}
